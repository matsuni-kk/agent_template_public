...
| Skill | 用途 | コピー元 |
|-------|------|---------|
| skill-maintenance | Skill作成・編集・削除 | `.cursor/skills/skill-maintenance/` |
| subagent-maintenance | サブエージェント管理 | `.cursor/skills/subagent-maintenance/` |
...
```bash
# skill-maintenance
cp -r .cursor/skills/skill-maintenance output/{domain}_agent/.cursor/skills/

# subagent-maintenance
cp -r .cursor/skills/subagent-maintenance output/{domain}_agent/.cursor/skills/
```
...
# 必須Skills
cp -r .cursor/skills/skill-maintenance "${OUTPUT_DIR}/.cursor/skills/"
cp -r .cursor/skills/subagent-maintenance "${OUTPUT_DIR}/.cursor/skills/"
