...
| Skill | 用途 | コピー元 |
|-------|------|---------|
| skill-maintenance | Skill作成・編集・削除 | `.codex/skills/skill-maintenance/` |
| subagent-maintenance | サブエージェント管理 | `.codex/skills/subagent-maintenance/` |
...
# 必須Skills
cp -r .codex/skills/skill-maintenance "${OUTPUT_DIR}/.codex/skills/"
cp -r .codex/skills/subagent-maintenance "${OUTPUT_DIR}/.codex/skills/"
